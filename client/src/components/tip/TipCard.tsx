...
export function TipCard() {
  ...
  return (
    <Card className="w-100 p-2 sm:w-[31rem]">
      <h2 className="text-primary-500">Connect Ethereum Classic to any chain using Quark!</h2>
      <div className="flex items-end justify-between">
        <p className="mt-1 max-w-[75%] text-xs">
          Quark is a protocol for connecting Ethereum Classic to any chain using Hyperlane Warp Routes.
          It is a simple and secure way to bridge tokens between chains.
        </p>
        <a
          href={links.github}
          target="_blank"
